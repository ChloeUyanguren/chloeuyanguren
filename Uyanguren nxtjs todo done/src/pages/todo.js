                    ...
                    {todos.map((todo, index) => {
                        return(
                            <li className="text-lg pt-5 flex" key={index}>
                                ...
                                <div>
                                    <button onClick={() => doneClicked(index, todo)} className="mt-3 mr-4 shadow bg-indigo-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                                        Done
                                    </button>
